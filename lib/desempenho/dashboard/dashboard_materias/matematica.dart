...
class DashboardMatematica extends StatefulWidget {
  @override
  _DashboardMatematicaState createState() => _DashboardMatematicaState();
}

class _DashboardMatematicaState extends State<DashboardMatematica> {
  ...
  Widget build(BuildContext context) {
    return DashBoard(
      primarycolor: Color.fromARGB(250, 253, 110, 33),
      secondarycolor: Color.fromARGB(40, 253, 110, 33),
      materia: "Matemática",
  ...
  Future<File> _getFileresultados() async {
    ...
    final directoryfoldertest = File("${directory.path}/materiasmatematica/materiasmatematica.json");
  ...
  Future<File> _getFileano1() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/primeiroanomatematica/primeiroanomatematica.json");
  ...
  Future<File> _getFileano2() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/segundoanomatematica/segundoanomatematica.json");
  ...
  Future<File> _getFileano3() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/terceiroanomatematica/terceiroanomatematica.json");
