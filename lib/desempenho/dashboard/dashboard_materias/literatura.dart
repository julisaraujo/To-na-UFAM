...
class DashboardLiteratura extends StatefulWidget {
  @override
  _DashboardLiteraturaState createState() => _DashboardLiteraturaState();
}

class _DashboardLiteraturaState extends State<DashboardLiteratura> {
  ...
  Widget build(BuildContext context) {
    return DashBoard(
      primarycolor: Color.fromARGB(250, 174, 59, 241),
      secondarycolor: Color.fromARGB(40, 174, 59, 241),
      materia: "Literatura",
  ...
  Future<File> _getFileresultados() async {
    ...
    final directoryfoldertest = File("${directory.path}/materiasliteratura/materiasliteratura.json");
  ...
  Future<File> _getFileano1() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/primeiroanoliteratura/primeiroanoliteratura.json");
  ...
  Future<File> _getFileano2() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/segundoanoliteratura/segundoanoliteratura.json");
  ...
  Future<File> _getFileano3() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/terceiroanoliteratura/terceiroanoliteratura.json");
