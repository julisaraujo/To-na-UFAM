...
class DashboardGeografia extends StatefulWidget {
  @override
  _DashboardGeografiaState createState() => _DashboardGeografiaState();
}

class _DashboardGeografiaState extends State<DashboardGeografia> {
  ...
  Widget build(BuildContext context) {
    return DashBoard(
      primarycolor: Color.fromARGB(250, 57, 186, 255),
      secondarycolor: Color.fromARGB(40, 57, 186, 255),
      materia: "Geografia",
  ...
  Future<File> _getFileano1() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/primeiroanogeografia/primeiroanogeografia.json");
  ...
  Future<File> _getFileano2() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/segundoanogeografia/segundoanogeografia.json");
  ...
  Future<File> _getFileano3() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/terceiroanogeografia/terceiroanogeografia.json");
