...
class DashboardHistoria extends StatefulWidget {
  @override
  _DashboardHistoriaState createState() => _DashboardHistoriaState();
}

class _DashboardHistoriaState extends State<DashboardHistoria> {
  ...
  Widget build(BuildContext context) {
    return DashBoard(
      primarycolor: Color.fromARGB(250, 130, 253, 0),
      secondarycolor: Color.fromARGB(40, 130, 253, 0),
      materia: "História",
  ...
  Future<File> _getFileano1() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/primeiroanohistoria/primeiroanohistoria.json");
  ...
  Future<File> _getFileano2() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/segundoanohistoria/segundoanohistoria.json");
  ...
  Future<File> _getFileano3() async {
    final directory = await getApplicationDocumentsDirectory();
    final directoryfoldertest = File("${directory.path}/terceiroanohistoria/terceiroanohistoria.json");
