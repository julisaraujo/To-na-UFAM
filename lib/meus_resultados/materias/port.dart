...
class _PortuguesState extends State<Portugues> {
  ...
  Widget build(BuildContext context) {
    return ModelResultados(
        ...
        list: encodelist,
        icone: MaterialCommunityIcons.alphabetical,
        add: () {
          setState(() {
            if (_assuntoKey.currentState.validate() &&
                _rightquestionsKey.currentState.validate() &&
                _allquestionsKey.currentState.validate()) {
