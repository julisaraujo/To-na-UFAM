...
class Literatura extends StatefulWidget {
  @override
  _LiteraturaState createState() => _LiteraturaState();
}

class _LiteraturaState extends State<Literatura> {
  ...
  Widget build(BuildContext context) {
    return ModelResultados(
      ...
      list:encodelist,
      icone:MaterialCommunityIcons.drama_masks,
      add:() {
        setState(() {
